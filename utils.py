...
def grammars_from_dataset(dataset_type, rec_depth_train=None, rec_depth_gen=None):
    if dataset_type == "batch":
        return (
            "grammars/batch/preprocessed-combined-6.irtg",
            [
        ...
        return (
            "grammars/slog/preprocessed-slog-rec_pp.irtg",
            [
        ...
        return (
            "grammars/slog/preprocessed-slog-rec_cp.irtg",
            [
